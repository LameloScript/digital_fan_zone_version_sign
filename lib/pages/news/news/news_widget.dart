                        ...
                        Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewInfosResponse = snapshot.data!;
                              return Builder(
                                builder: (context) {
                                  final eachInfoos = getJsonField(
                                    listViewInfosResponse.jsonBody,
                                    r'''$.data[:].attributes''',
                                  ).toList();
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    scrollDirection: Axis.vertical,
                                    itemCount: eachInfoos.length,
                                    itemBuilder: (context, eachInfoosIndex) {
                                      final eachInfoosItem =
                                          eachInfoos[eachInfoosIndex];
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewNewsRssResponse = snapshot.data!;
                              return Builder(
                                builder: (context) {
                                  final eachRss = NewsRssCall.data(
                                        listViewNewsRssResponse.jsonBody,
                                      )?.toList() ??
                                      [];
                                  return RefreshIndicator(
                                    ...
                                    child: ListView.builder(
                                      padding: EdgeInsets.zero,
                                      scrollDirection: Axis.vertical,
                                      itemCount: eachRss.length,
                                      itemBuilder: (context, eachRssIndex) {
                                        final eachRssItem =
                                            eachRss[eachRssIndex];
                                        return SingleChildScrollView(
                                          child: Column(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
