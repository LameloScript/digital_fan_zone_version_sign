...
class _CarteWidgetState extends State<CarteWidget>
  ...
  final _screenshotController = ScreenshotController();
    ...
    await GallerySaver.saveImage(file.path, albumName: "PASSEPORT CAN");

    // Get the saved image path
    String savedImagePath = "$tempPath/image.png";

    // Share the saved image
    await Share.shareFiles([savedImagePath], text: '#Passeport #Can');
  }
